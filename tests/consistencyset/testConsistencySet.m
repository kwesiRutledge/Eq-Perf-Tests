...
function test1_ConsistencySet(testCase)
	...
	[ConsistencySet1,InternalBehaviorSet1] = lcsas0.consistent_set( 1 , L1 , P_u , P_x0 , 'fb_method' , 'output' );
	[ConsistencySet2,InternalBehaviorSet2] = lcsas0.consistency_set2( 1 , L1 , P_u , P_x0 , 'fb_method' , 'output' );
