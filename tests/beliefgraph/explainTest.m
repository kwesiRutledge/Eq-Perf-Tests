...
function test_NodeWhichExplainsExternalBehavior1(testCase)
	%Description:
	...
	[temp_node,temp_node_index] = BG1.NodeWhichExplainsExternalBehavior(-0.1);

	assert( 2 == temp_node_index )

function test_NodeWhichExplainsExternalBehavior2(testCase)
	%Description:
