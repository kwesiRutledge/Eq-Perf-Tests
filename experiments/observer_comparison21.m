...
%			M1 - 		
	...
	[contr2_fcn,optim2_fcn] = create_fhae_w_eq_recovery('min_M2',M1,T,test_sys,'verbosity',2,'pattern',exp1.pattern1)
	...
	[xi_t,xi_mag_t] 	= apply_controller_to_rollouts(test_sys,contr1_fcn,T,num_rollouts,M1);
