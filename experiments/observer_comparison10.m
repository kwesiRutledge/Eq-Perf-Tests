function [ results ] = observer_comparison10( varargin )
	%	observer_comparison6.m
	%		The goal of this test is to plot the triangle inequalities
	%		optimal performance against the optimal estimator's.
	%		Hopefully, we'll submit these with the paper.
	...
	% legend('Optimal Affine Observer','Desired Performance Level')
